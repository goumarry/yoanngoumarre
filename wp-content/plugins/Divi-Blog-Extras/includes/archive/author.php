...
<div id="main-content">
	...
	if ( isset( $plugin_options['author-archive-layout-type'] ) ) {
		if ( 'full-width' !== $plugin_options['author-archive-layout-type'] ) {
			?>
			<div class="container">
	...
	$module_id = $plugin_options['author-archive-layout'];
